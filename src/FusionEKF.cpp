  ...
  if (!is_initialized_) {
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
      ...
      float rhoDot = measurement_pack.raw_measurements_[2]; // Doppler/radial velocity
      ...
      /*
      Initial state with initial location and zero velocity.
      */
    ...
    // ekf_.Init(x_, P_, F_, H_laser_, R_laser_);
